...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse getAccountsPageByChannelIdHttpResponse(
			Long channelId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Page<Account> getAccountsPageByChannelId(
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountsPageByChannelIdHttpResponse(
		...
		public HttpInvoker.HttpResponse getAccountsPageByChannelIdHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-account/v1.0/accounts/by-channelId/{channelId}");
