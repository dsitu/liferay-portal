...
public interface GroupedProductResource {
	...
	public GroupedProduct getGroupedProduct(Long groupedProductId)
		throws Exception;

	public HttpInvoker.HttpResponse getGroupedProductHttpResponse(
			Long groupedProductId)
		throws Exception;
	...
	public static class GroupedProductResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/grouped-products/{groupedProductId}");
		...
		public HttpInvoker.HttpResponse deleteGroupedProductBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/grouped-products/batch");
		...
		public GroupedProduct getGroupedProduct(Long groupedProductId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getGroupedProductHttpResponse(groupedProductId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/by-externalReferenceCode/{externalReferenceCode}/grouped-products");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{productId}/grouped-products");
