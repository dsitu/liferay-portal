...
public interface PinResource {
	...
	public HttpInvoker.HttpResponse getPinHttpResponse(Long pinId)
		throws Exception;
	...
	public static class PinResourceImpl implements PinResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/pins/{pinId}");
		...
		public HttpInvoker.HttpResponse deletePinBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/pins/batch");
		...
		public Pin getPin(Long pinId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getPinHttpResponse(pinId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/by-externalReferenceCode/{externalReferenceCode}/pins");
		...
		public HttpInvoker.HttpResponse getProductPinsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{productId}/pins");
