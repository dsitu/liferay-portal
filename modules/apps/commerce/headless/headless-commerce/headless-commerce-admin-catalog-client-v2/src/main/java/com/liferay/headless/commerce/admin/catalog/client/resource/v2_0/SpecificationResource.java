...
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.SpecificationSerDes;
	...
	public static class SpecificationResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/specifications");
		...
		public HttpInvoker.HttpResponse postSpecificationBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/specifications/batch");
		...
		public HttpInvoker.HttpResponse deleteSpecificationHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/specifications/{id}");
