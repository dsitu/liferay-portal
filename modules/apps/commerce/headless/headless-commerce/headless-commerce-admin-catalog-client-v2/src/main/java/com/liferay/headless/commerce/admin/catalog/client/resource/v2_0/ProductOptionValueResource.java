...
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.ProductOptionValueSerDes;
	...
	public static class ProductOptionValueResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/productOptions/{id}/productOptionValues");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/productOptions/productOptionValues/batch");
