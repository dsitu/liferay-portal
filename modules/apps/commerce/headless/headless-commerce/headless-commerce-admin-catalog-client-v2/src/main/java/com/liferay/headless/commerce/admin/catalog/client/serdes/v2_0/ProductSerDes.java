...
package com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0;
...
import com.liferay.headless.commerce.admin.catalog.client.dto.v2_0.CustomField;
import com.liferay.headless.commerce.admin.catalog.client.dto.v2_0.LinkedProduct;
...
public class ProductSerDes {
	...
	public static String toJSON(Product product) {
		...
		if (product.getImageAttachments() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < product.getImageAttachments().length; i++) {
				sb.append(String.valueOf(product.getImageAttachments()[i]));

				if ((i + 1) < product.getImageAttachments().length) {
					sb.append(", ");
				}
			}
	...
	public static Map<String, String> toMap(Product product) {
		...
		if (product.getImageAttachments() == null) {
			map.put("imageAttachments", null);
		}
		else {
			map.put(
				"imageAttachments",
				String.valueOf(product.getImageAttachments()));
		}
	...
	public static class ProductJSONParser extends BaseJSONParser<Product> {
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "imageAttachments")) {
				if (jsonParserFieldValue != null) {
					product.setImageAttachments(
						Stream.of(
							toStrings((Object[])jsonParserFieldValue)
						).map(
							object -> AttachmentSerDes.toDTO((String)object)
