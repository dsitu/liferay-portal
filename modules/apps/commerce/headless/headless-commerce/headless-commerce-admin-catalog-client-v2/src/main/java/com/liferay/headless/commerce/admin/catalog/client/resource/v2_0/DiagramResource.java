...
public interface DiagramResource {
	...
	public Diagram getDiagram(Long diagramId) throws Exception;

	public HttpInvoker.HttpResponse getDiagramHttpResponse(Long diagramId)
		throws Exception;
	...
	public static class DiagramResourceImpl implements DiagramResource {
		...
		public Diagram getDiagram(Long diagramId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getDiagramHttpResponse(
				diagramId);
			...
			try {
				return com.liferay.headless.commerce.admin.catalog.client.
					serdes.v2_0.DiagramSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/diagrams/{diagramId}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/by-externalReferenceCode/{externalReferenceCode}/diagrams");
		...
		public HttpInvoker.HttpResponse getProductDiagramHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{productId}/diagrams");
