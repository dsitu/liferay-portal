	...
	public static class ProductConfigurationResourceImpl
		...
		public ProductConfiguration
			...
			try {
				return com.liferay.headless.commerce.admin.catalog.client.
					serdes.v2_0.ProductConfigurationSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/by-externalReferenceCode/{externalReferenceCode}/configuration");
		...
		public HttpInvoker.HttpResponse getProductIdConfigurationHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{id}/configuration");
