...
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.CategorySerDes;
	...
	public static class CategoryResourceImpl implements CategoryResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/by-externalReferenceCode/{externalReferenceCode}/categories");
		...
		public HttpInvoker.HttpResponse getProductIdCategoriesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{id}/categories");
