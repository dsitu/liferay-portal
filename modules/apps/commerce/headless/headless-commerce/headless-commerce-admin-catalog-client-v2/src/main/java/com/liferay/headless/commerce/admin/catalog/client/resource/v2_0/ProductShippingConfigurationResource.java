	...
	public static class ProductShippingConfigurationResourceImpl
		...
		public ProductShippingConfiguration
			...
			try {
				return com.liferay.headless.commerce.admin.catalog.client.
					serdes.v2_0.ProductShippingConfigurationSerDes.toDTO(
						content);
			}
			catch (Exception e) {
				_logger.log(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/by-externalReferenceCode/{externalReferenceCode}/shippingConfiguration");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{id}/shippingConfiguration");
