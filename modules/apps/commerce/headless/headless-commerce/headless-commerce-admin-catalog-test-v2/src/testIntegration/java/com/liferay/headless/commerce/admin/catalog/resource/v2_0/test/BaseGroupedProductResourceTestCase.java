...
import com.liferay.headless.commerce.admin.catalog.client.dto.v2_0.GroupedProduct;
import com.liferay.headless.commerce.admin.catalog.client.http.HttpInvoker;
import com.liferay.headless.commerce.admin.catalog.client.pagination.Page;
import com.liferay.headless.commerce.admin.catalog.client.pagination.Pagination;
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.GroupedProductResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.GroupedProductSerDes;
...
public abstract class BaseGroupedProductResourceTestCase {
	...
	public void testDeleteGroupedProduct() throws Exception {
		...
		assertHttpResponseStatusCode(
			404,
			groupedProductResource.getGroupedProductHttpResponse(
				groupedProduct.getId()));

		assertHttpResponseStatusCode(
			404, groupedProductResource.getGroupedProductHttpResponse(0L));
	}
	...
	@Test
	public void testGetGroupedProduct() throws Exception {
		GroupedProduct postGroupedProduct =
			testGetGroupedProduct_addGroupedProduct();

		GroupedProduct getGroupedProduct =
			groupedProductResource.getGroupedProduct(
				postGroupedProduct.getId());

		assertEquals(postGroupedProduct, getGroupedProduct);
		assertValid(getGroupedProduct);
	}

	protected GroupedProduct testGetGroupedProduct_addGroupedProduct()
		throws Exception {
	...
	@Test
	public void testGraphQLGetGroupedProduct() throws Exception {
		GroupedProduct groupedProduct =
			testGraphQLGetGroupedProduct_addGroupedProduct();

		Assert.assertTrue(
			equals(
				groupedProduct,
				GroupedProductSerDes.toDTO(
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/groupedProduct"))));
	}

	@Test
	public void testGraphQLGetGroupedProductNotFound() throws Exception {
		Long irrelevantGroupedProductId = RandomTestUtil.randomLong();
	...
	protected GroupedProduct testGraphQLGetGroupedProduct_addGroupedProduct()
		throws Exception {
	...
	public void testPatchGroupedProduct() throws Exception {
		GroupedProduct postGroupedProduct =
			testPatchGroupedProduct_addGroupedProduct();

		GroupedProduct randomPatchGroupedProduct = randomPatchGroupedProduct();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		GroupedProduct patchGroupedProduct =
			groupedProductResource.patchGroupedProduct(
				postGroupedProduct.getId(), randomPatchGroupedProduct);

		GroupedProduct expectedPatchGroupedProduct = postGroupedProduct.clone();

		BeanTestUtil.copyProperties(
			randomPatchGroupedProduct, expectedPatchGroupedProduct);

		GroupedProduct getGroupedProduct =
			groupedProductResource.getGroupedProduct(
				patchGroupedProduct.getId());

		assertEquals(expectedPatchGroupedProduct, getGroupedProduct);
		assertValid(getGroupedProduct);
	}

	protected GroupedProduct testPatchGroupedProduct_addGroupedProduct()
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.commerce.admin.catalog.dto.v2_0.
	...
	@Inject
	private com.liferay.headless.commerce.admin.catalog.resource.v2_0.
