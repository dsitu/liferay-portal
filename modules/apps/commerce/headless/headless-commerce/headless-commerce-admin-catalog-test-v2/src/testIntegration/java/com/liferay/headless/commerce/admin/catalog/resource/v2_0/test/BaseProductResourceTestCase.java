...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.ProductResource;
...
public abstract class BaseProductResourceTestCase {
	...
	protected void assertValid(Product product) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("imageAttachments", additionalAssertFieldName)) {
	...
	protected boolean equals(Product product1, Product product2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("imageAttachments", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						product1.getImageAttachments(),
						product2.getImageAttachments())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("imageAttachments")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
