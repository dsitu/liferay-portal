...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.ProductTaxConfigurationResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.ProductTaxConfigurationSerDes;
...
public abstract class BaseProductTaxConfigurationResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		productTaxConfiguration.setExternalReferenceCode(regex);
		...
		Assert.assertEquals(
			regex, productTaxConfiguration.getExternalReferenceCode());
	...
	protected String
		...
		return productTaxConfiguration.getExternalReferenceCode();
	}
	...
	public void testPatchProductByExternalReferenceCodeTaxConfiguration()
		...
		ProductTaxConfiguration patchProductTaxConfiguration =
			productTaxConfigurationResource.
				patchProductByExternalReferenceCodeTaxConfiguration(
					postProductTaxConfiguration.getExternalReferenceCode(),
					randomPatchProductTaxConfiguration);

		ProductTaxConfiguration expectedPatchProductTaxConfiguration =
			postProductTaxConfiguration.clone();

		BeanTestUtil.copyProperties(
			randomPatchProductTaxConfiguration,
			expectedPatchProductTaxConfiguration);

		ProductTaxConfiguration getProductTaxConfiguration =
			productTaxConfigurationResource.
				getProductByExternalReferenceCodeTaxConfiguration(
					patchProductTaxConfiguration.getExternalReferenceCode());

		assertEquals(
			expectedPatchProductTaxConfiguration, getProductTaxConfiguration);
		assertValid(getProductTaxConfiguration);
	}
	...
	public void testPatchProductIdTaxConfiguration() throws Exception {
		...
		ProductTaxConfiguration getProductTaxConfiguration =
			productTaxConfigurationResource.getProductIdTaxConfiguration(
				patchProductTaxConfiguration.getId());
	...
	protected void assertValid(ProductTaxConfiguration productTaxConfiguration)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (productTaxConfiguration.getExternalReferenceCode() ==
						null) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						productTaxConfiguration1.getExternalReferenceCode(),
						productTaxConfiguration2.getExternalReferenceCode())) {
