...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.ProductOptionResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.ProductOptionSerDes;
...
public abstract class BaseProductOptionResourceTestCase {
	...
	public void testPatchProductOption() throws Exception {
		ProductOption postProductOption =
			testPatchProductOption_addProductOption();

		ProductOption randomPatchProductOption = randomPatchProductOption();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		ProductOption patchProductOption =
			productOptionResource.patchProductOption(
				postProductOption.getId(), randomPatchProductOption);

		ProductOption expectedPatchProductOption = postProductOption.clone();

		BeanTestUtil.copyProperties(
			randomPatchProductOption, expectedPatchProductOption);

		ProductOption getProductOption = productOptionResource.getProductOption(
			patchProductOption.getId());

		assertEquals(expectedPatchProductOption, getProductOption);
		assertValid(getProductOption);
	}
