...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.OptionValueResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.OptionValueSerDes;
...
public abstract class BaseOptionValueResourceTestCase {
	...
	public void testPatchOptionValueByExternalReferenceCode() throws Exception {
		...
		@SuppressWarnings("PMD.UnusedLocalVariable")
		OptionValue patchOptionValue =
			optionValueResource.patchOptionValueByExternalReferenceCode(
				postOptionValue.getExternalReferenceCode(),
				randomPatchOptionValue);

		OptionValue expectedPatchOptionValue = postOptionValue.clone();

		BeanTestUtil.copyProperties(
			randomPatchOptionValue, expectedPatchOptionValue);

		OptionValue getOptionValue =
			optionValueResource.getOptionValueByExternalReferenceCode(
				patchOptionValue.getExternalReferenceCode());

		assertEquals(expectedPatchOptionValue, getOptionValue);
		assertValid(getOptionValue);
	}
	...
	public void testPatchOptionValue() throws Exception {
		OptionValue postOptionValue = testPatchOptionValue_addOptionValue();

		OptionValue randomPatchOptionValue = randomPatchOptionValue();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		OptionValue patchOptionValue = optionValueResource.patchOptionValue(
