...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.ProductGroupResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.ProductGroupSerDes;
...
public abstract class BaseProductGroupResourceTestCase {
	...
	public void testPatchProductGroupByExternalReferenceCode()
		...
		@SuppressWarnings("PMD.UnusedLocalVariable")
		ProductGroup patchProductGroup =
		...
		ProductGroup getProductGroup =
			productGroupResource.getProductGroupByExternalReferenceCode(
				patchProductGroup.getExternalReferenceCode());
	...
	public void testPatchProductGroup() throws Exception {
		ProductGroup postProductGroup = testPatchProductGroup_addProductGroup();

		ProductGroup randomPatchProductGroup = randomPatchProductGroup();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		ProductGroup patchProductGroup = productGroupResource.patchProductGroup(
