...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.OptionResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.OptionSerDes;
...
public abstract class BaseOptionResourceTestCase {
	...
	public void testPatchOptionByExternalReferenceCode() throws Exception {
		Option postOption = testPatchOptionByExternalReferenceCode_addOption();

		Option randomPatchOption = randomPatchOption();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		Option patchOption = optionResource.patchOptionByExternalReferenceCode(
			postOption.getExternalReferenceCode(), randomPatchOption);

		Option expectedPatchOption = postOption.clone();

		BeanTestUtil.copyProperties(randomPatchOption, expectedPatchOption);

		Option getOption = optionResource.getOptionByExternalReferenceCode(
			patchOption.getExternalReferenceCode());

		assertEquals(expectedPatchOption, getOption);
		assertValid(getOption);
	}
	...
	public void testPatchOption() throws Exception {
		Option postOption = testPatchOption_addOption();

		Option randomPatchOption = randomPatchOption();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		Option patchOption = optionResource.patchOption(
			postOption.getId(), randomPatchOption);

		Option expectedPatchOption = postOption.clone();

		BeanTestUtil.copyProperties(randomPatchOption, expectedPatchOption);

		Option getOption = optionResource.getOption(patchOption.getId());
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.commerce.admin.catalog.dto.v2_0.Option.
						class)) {
	...
	@Inject
	private
		com.liferay.headless.commerce.admin.catalog.resource.v2_0.OptionResource
			_optionResource;
