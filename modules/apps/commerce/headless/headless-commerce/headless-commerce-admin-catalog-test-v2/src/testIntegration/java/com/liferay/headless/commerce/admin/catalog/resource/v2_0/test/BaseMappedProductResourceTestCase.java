...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.MappedProductResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.MappedProductSerDes;
...
public abstract class BaseMappedProductResourceTestCase {
	...
	public void testDeleteMappedProduct() throws Exception {
		...
		assertHttpResponseStatusCode(
			404,
			mappedProductResource.getMappedProductHttpResponse(
				mappedProduct.getId()));

		assertHttpResponseStatusCode(
			404, mappedProductResource.getMappedProductHttpResponse(0L));
	}
	...
	@Test
	public void testGetMappedProduct() throws Exception {
		MappedProduct postMappedProduct =
			testGetMappedProduct_addMappedProduct();

		MappedProduct getMappedProduct = mappedProductResource.getMappedProduct(
			postMappedProduct.getId());
	...
	@Test
	public void testGraphQLGetMappedProduct() throws Exception {
		MappedProduct mappedProduct =
			testGraphQLGetMappedProduct_addMappedProduct();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/mappedProduct"))));
	}

	@Test
	public void testGraphQLGetMappedProductNotFound() throws Exception {
		Long irrelevantMappedProductId = RandomTestUtil.randomLong();
	...
	protected MappedProduct testGraphQLGetMappedProduct_addMappedProduct()
		throws Exception {
	...
	public void testPatchMappedProduct() throws Exception {
		MappedProduct postMappedProduct =
			testPatchMappedProduct_addMappedProduct();

		MappedProduct randomPatchMappedProduct = randomPatchMappedProduct();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		MappedProduct patchMappedProduct =
			mappedProductResource.patchMappedProduct(
				postMappedProduct.getId(), randomPatchMappedProduct);

		MappedProduct expectedPatchMappedProduct = postMappedProduct.clone();

		BeanTestUtil.copyProperties(
			randomPatchMappedProduct, expectedPatchMappedProduct);

		MappedProduct getMappedProduct = mappedProductResource.getMappedProduct(
			patchMappedProduct.getId());

		assertEquals(expectedPatchMappedProduct, getMappedProduct);
		assertValid(getMappedProduct);
	}
