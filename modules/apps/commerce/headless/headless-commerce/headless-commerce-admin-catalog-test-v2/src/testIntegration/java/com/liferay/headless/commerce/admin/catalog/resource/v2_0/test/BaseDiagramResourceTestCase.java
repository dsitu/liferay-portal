...
import com.liferay.headless.commerce.admin.catalog.client.resource.v2_0.DiagramResource;
import com.liferay.headless.commerce.admin.catalog.client.serdes.v2_0.DiagramSerDes;
...
public abstract class BaseDiagramResourceTestCase {
	...
	public void testGetDiagram() throws Exception {
		Diagram postDiagram = testGetDiagram_addDiagram();

		Diagram getDiagram = diagramResource.getDiagram(postDiagram.getId());
	...
	@Test
	public void testGraphQLGetDiagram() throws Exception {
		Diagram diagram = testGraphQLGetDiagram_addDiagram();
						...
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put("diagramId", diagram.getId());
									}
								},
								getGraphQLFields())),
						"JSONObject/data", "Object/diagram"))));
	}

	@Test
	public void testGraphQLGetDiagramNotFound() throws Exception {
		Long irrelevantDiagramId = RandomTestUtil.randomLong();
			...
			JSONUtil.getValueAsString(
				invokeGraphQLQuery(
					new GraphQLField(
						...
						new HashMap<String, Object>() {
							{
								put("diagramId", irrelevantDiagramId);
							}
						},
						getGraphQLFields())),
	...
	protected Diagram testGraphQLGetDiagram_addDiagram() throws Exception {
		return testGraphQLDiagram_addDiagram();
	}

	@Test
	public void testPatchDiagram() throws Exception {
		Diagram postDiagram = testPatchDiagram_addDiagram();

		Diagram randomPatchDiagram = randomPatchDiagram();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		Diagram patchDiagram = diagramResource.patchDiagram(
			postDiagram.getId(), randomPatchDiagram);

		Diagram expectedPatchDiagram = postDiagram.clone();

		BeanTestUtil.copyProperties(randomPatchDiagram, expectedPatchDiagram);

		Diagram getDiagram = diagramResource.getDiagram(patchDiagram.getId());

		assertEquals(expectedPatchDiagram, getDiagram);
		assertValid(getDiagram);
	}
	...
	protected Diagram testPostProductDiagram_addDiagram(Diagram diagram)
		...
		return diagramResource.postProductDiagram(
			testGetProductDiagramsPage_getProductId(), diagram);
	}
	...
	@Inject
	private
		com.liferay.headless.commerce.admin.catalog.resource.v2_0.
