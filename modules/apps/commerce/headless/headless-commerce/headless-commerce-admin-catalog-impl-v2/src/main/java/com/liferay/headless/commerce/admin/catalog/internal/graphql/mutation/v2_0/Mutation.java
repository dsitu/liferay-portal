...
package com.liferay.headless.commerce.admin.catalog.internal.graphql.mutation.v2_0;

import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Attachment;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.AttachmentBase64;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.AttachmentUrl;
...
public class Mutation {
	...
	@GraphQLField
	public boolean deleteCatalogByExternalReferenceCode(
			@GraphQLName("externalReferenceCode") String externalReferenceCode)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteCatalog(@GraphQLName("id") Long id) throws Exception {
		_applyVoidComponentServiceObjects(
			_catalogResourceComponentServiceObjects,
			this::_populateResourceContext,
	...
	@GraphQLField
	public boolean deleteOptionByExternalReferenceCode(
			@GraphQLName("externalReferenceCode") String externalReferenceCode)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteOption(@GraphQLName("id") Long id) throws Exception {
		_applyVoidComponentServiceObjects(
			_optionResourceComponentServiceObjects,
			this::_populateResourceContext,
	...
	@GraphQLField
	public boolean deleteOptionCategory(@GraphQLName("id") Long id)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteOptionValueByExternalReferenceCode(
			@GraphQLName("externalReferenceCode") String externalReferenceCode)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteOptionValue(@GraphQLName("id") Long id)
		throws Exception {
	...
	@GraphQLField
	public OptionValue patchOptionValue(
			@GraphQLName("id") Long id,
			@GraphQLName("optionValue") OptionValue optionValue)
		throws Exception {
	...
	@GraphQLField
	public ProductGroup patchProductGroup(
			@GraphQLName("id") Long id,
			@GraphQLName("productGroup") ProductGroup productGroup)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteProductOption(@GraphQLName("id") Long id)
		throws Exception {
	...
	@GraphQLField
	public ProductShippingConfiguration patchProductIdShippingConfiguration(
			@GraphQLName("id") Long id,
			@GraphQLName("productShippingConfiguration")
				ProductShippingConfiguration productShippingConfiguration)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteRelatedProduct(@GraphQLName("id") Long id)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteSkuByExternalReferenceCode(
			@GraphQLName("externalReferenceCode") String externalReferenceCode)
		throws Exception {
	...
	@GraphQLField
	public boolean deleteSku(@GraphQLName("id") Long id) throws Exception {
		_applyVoidComponentServiceObjects(
			_skuResourceComponentServiceObjects, this::_populateResourceContext,
