...
package com.liferay.headless.commerce.admin.catalog.internal.graphql.query.v2_0;

import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Attachment;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Catalog;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Category;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Diagram;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.GroupedProduct;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.LinkedProduct;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.MappedProduct;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Option;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.OptionCategory;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.OptionValue;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Pin;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Product;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductAccountGroup;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductChannel;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductConfiguration;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductGroup;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductGroupProduct;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductOption;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductOptionValue;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductShippingConfiguration;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductSpecification;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductSubscriptionConfiguration;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.ProductTaxConfiguration;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.RelatedProduct;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Sku;
import com.liferay.headless.commerce.admin.catalog.dto.v2_0.Specification;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.AttachmentResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.CatalogResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.CategoryResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.DiagramResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.GroupedProductResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.LinkedProductResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.MappedProductResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.OptionCategoryResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.OptionResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.OptionValueResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.PinResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductAccountGroupResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductChannelResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductConfigurationResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductGroupProductResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductGroupResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductOptionResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductOptionValueResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductShippingConfigurationResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductSpecificationResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductSubscriptionConfigurationResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.ProductTaxConfigurationResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.RelatedProductResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.SkuResource;
import com.liferay.headless.commerce.admin.catalog.resource.v2_0.SpecificationResource;
...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {diagram(diagramId: ___){attachmentBase64, color, id, imageId, imageURL, productExternalReferenceCode, productId, radius, type}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public Diagram diagram(@GraphQLName("diagramId") Long diagramId)
		throws Exception {

		return _applyComponentServiceObjects(
			_diagramResourceComponentServiceObjects,
			this::_populateResourceContext,
			diagramResource -> diagramResource.getDiagram(diagramId));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {groupedProduct(groupedProductId: ___){entryProductExternalReferenceCode, entryProductId, entryProductName, id, priority, productExternalReferenceCode, productId, productName, quantity}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public GroupedProduct groupedProduct(
		...
		return _applyComponentServiceObjects(
			_groupedProductResourceComponentServiceObjects,
			this::_populateResourceContext,
			groupedProductResource -> groupedProductResource.getGroupedProduct(
				groupedProductId));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {mappedProduct(mappedProductId: ___){actions, customFields, id, productExternalReferenceCode, productId, productName, quantity, sequence, sku, skuExternalReferenceCode, skuId, type}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public MappedProduct mappedProduct(
		...
		return _applyComponentServiceObjects(
			_mappedProductResourceComponentServiceObjects,
			this::_populateResourceContext,
			mappedProductResource -> mappedProductResource.getMappedProduct(
				mappedProductId));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {pin(pinId: ___){id, mappedProduct, positionX, positionY, sequence}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public Pin pin(@GraphQLName("pinId") Long pinId) throws Exception {
		return _applyComponentServiceObjects(
			_pinResourceComponentServiceObjects, this::_populateResourceContext,
			pinResource -> pinResource.getPin(pinId));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {productByExternalReferenceCodeTaxConfiguration(externalReferenceCode: ___){externalReferenceCode, id, taxCategory, taxable}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {productIdTaxConfiguration(id: ___){externalReferenceCode, id, taxCategory, taxable}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
