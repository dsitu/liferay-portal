...
public abstract class BaseAccountResourceTestCase {
	...
	@Test
	public void testGetAccountsPageByChannelId() throws Exception {
		Long channelId = testGetAccountsPageByChannelId_getChannelId();
		Long irrelevantChannelId =
			testGetAccountsPageByChannelId_getIrrelevantChannelId();

		Page<Account> page = accountResource.getAccountsPageByChannelId(
		...
		if (irrelevantChannelId != null) {
			Account irrelevantAccount =
				testGetAccountsPageByChannelId_addAccount(
					irrelevantChannelId, randomIrrelevantAccount());

			page = accountResource.getAccountsPageByChannelId(
		...
		Account account1 = testGetAccountsPageByChannelId_addAccount(
			channelId, randomAccount());

		Account account2 = testGetAccountsPageByChannelId_addAccount(
			channelId, randomAccount());
	...
	@Test
	public void testGetAccountsPageByChannelIdWithFilterDateTimeEquals()
		throws Exception {
		...
		account1 = testGetAccountsPageByChannelId_addAccount(
			channelId, account1);
	...
	@Test
	public void testGetAccountsPageByChannelIdWithFilterStringEquals()
		throws Exception {
		...
		for (EntityField entityField : entityFields) {
			Page<Account> page = accountResource.getAccountsPageByChannelId(
				channelId, null, getFilterString(entityField, "eq", account1),
				Pagination.of(1, 2), null);
	...
	@Test
	public void testGetAccountsPageByChannelIdWithPagination()
		throws Exception {
		...
		Account account3 = testGetAccountsPageByChannelId_addAccount(
			channelId, randomAccount());

		Page<Account> page1 = accountResource.getAccountsPageByChannelId(
		...
		Page<Account> page2 = accountResource.getAccountsPageByChannelId(
		...
		Page<Account> page3 = accountResource.getAccountsPageByChannelId(
	...
	@Test
	public void testGetAccountsPageByChannelIdWithSortDateTime()
		throws Exception {

		testGetAccountsPageByChannelIdWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, account1, account2) -> {
				BeanUtils.setProperty(
					account1, entityField.getName(),
	...
	@Test
	public void testGetAccountsPageByChannelIdWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetAccountsPageByChannelIdWithSortString()
		throws Exception {
	...
	protected void testGetAccountsPageByChannelIdWithSort(
			EntityField.Type type,
			UnsafeTriConsumer<EntityField, Account, Account, Exception>
				unsafeTriConsumer)
		throws Exception {
		...
		account2 = testGetAccountsPageByChannelId_addAccount(
			channelId, account2);

		for (EntityField entityField : entityFields) {
			Page<Account> ascPage = accountResource.getAccountsPageByChannelId(
			...
			Page<Account> descPage = accountResource.getAccountsPageByChannelId(
				channelId, null, null, Pagination.of(1, 2),
				entityField.getName() + ":desc");
	...
	protected Account testGetAccountsPageByChannelId_addAccount(
	...
	protected Long testGetAccountsPageByChannelId_getChannelId()
		throws Exception {
	...
	protected Long testGetAccountsPageByChannelId_getIrrelevantChannelId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetAccountsPageByChannelId() throws Exception {
		Long channelId = testGetAccountsPageByChannelId_getChannelId();
		...
		Assert.assertEquals(2, accountsJSONObject.getLong("totalCount"));
