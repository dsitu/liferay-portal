...
package com.liferay.headless.commerce.admin.catalog.dto.v2_0;
...
public class Product implements Serializable {
	...
	public void setImageAttachments(Attachment[] imageAttachments) {
		this.imageAttachments = imageAttachments;
	}

	@JsonIgnore
	public void setImageAttachments(
		UnsafeSupplier<Attachment[], Exception>
			imageAttachmentsUnsafeSupplier) {

		try {
			imageAttachments = imageAttachmentsUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Attachment[] imageAttachments;
	...
	public String toString() {
		...
		if (imageAttachments != null) {
			...
			for (int i = 0; i < imageAttachments.length; i++) {
				sb.append(String.valueOf(imageAttachments[i]));
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.catalog.dto.v2_0.Product",
		name = "x-class-name"
	)
