...
long cpConfigurationListId = cpConfigurationListQualifiersDisplayContext.getCPConfigurationListId();

PortletURL portletCPConfigurationListURL = cpConfigurationListQualifiersDisplayContext.getPortletCPConfigurationListURL();
...
<aui:form action="<%= editCPConfigurationListQualifiersActionURL %>" cssClass="pt-4" method="post" name="fm">
	...
	<aui:input name="cpConfigurationListId" type="hidden" value="<%= cpConfigurationListId %>" />
