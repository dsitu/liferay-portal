 ...
 */
public class DeliveryGroupInfoDisplayContext {

	public DeliveryGroupInfoDisplayContext(
	...
	public CommerceAddress getCommerceAddress(
		...
		String commerceAddressIdString = ParamUtil.getString(
			httpServletRequest, "addressId");
