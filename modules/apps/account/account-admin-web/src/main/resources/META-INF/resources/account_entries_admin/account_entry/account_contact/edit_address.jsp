	...
	<clay:container-fluid>
		...
		<clay:sheet>
			...
			<clay:sheet-section>
				...
				<aui:select label="type" listType='<%= editContactInformationDisplayContext.getClassName() + ".contact" + ListTypeConstants.ADDRESS %>' listTypeFieldName="listTypeId" name="addressListTypeId" />
